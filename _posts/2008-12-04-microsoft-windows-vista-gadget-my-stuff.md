...
[http://schemas.xmlsoap.org/soap/envelope/&#8221](http://schemas.xmlsoap.org/soap/envelope/&#8221);

```
><soap:Body><'+WSfunction+' xmlns="urn:microsoft-dynamics-schemas/codeunit/GetMyStuff"><result></result></'+WSfunction+'></soap:Body></soap:Envelope>');
}
catch(e)
{
