...
-   Specify a secure URL to your development license file (or leave blank to use the demo license, which will allow you to make v2 extensions development in the range 50100 to 50149). See [this](/2017/02/26/create-a-secure-url-to-a-file/) blog post for info on how to create a secure url.
