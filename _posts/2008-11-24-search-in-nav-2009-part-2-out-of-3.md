...
<setting name=”NAVsearch\_SearchReference\_Search” serializeAs=”String”>  
<value>[http://localhost:7047/DynamicsNAV/WS/CRONUS\_International\_Ltd/Codeunit/Search](http://localhost:7047/DynamicsNAV/WS/CRONUS_International_Ltd/Codeunit/Search)</value>  
</setting>
...
/// </summary>  
private void bSearch\_Click(object sender, EventArgs e)  
{  
...
User32.RegisterHotKey(this.Handle, this.GetType().GetHashCode(), (int)Modifiers.MOD\_WIN, (int)Keys.Z);
...
{  
// Only react on WM\_HOTKEY  
if (m.Msg == (int)Msgs.WM\_HOTKEY)  
{  
...
/// </summary>  
private void SearchForm\_Deactivate(object sender, EventArgs e)  
{  
HideSearchForm();  
}
