...
**C:\\java>wsimport -d generated -s source [http://localhost:7047/DynamicsNAV/WS/SystemService](http://localhost:7047/DynamicsNAV/WS/SystemService)**
...
QName customerPageQName = new QName(“urn:microsoft-dynamics-schemas/page/customer”, “Customer\_Service”);
...
filter1.setField(CustomerFields.fromValue(“Location\_Code”));  
filter1.setCriteria(“RED|BLUE”);

  CustomerFilter filter2 = new CustomerFilter();  
filter2.setField(CustomerFields.fromValue(“Country\_Region\_Code”));  
